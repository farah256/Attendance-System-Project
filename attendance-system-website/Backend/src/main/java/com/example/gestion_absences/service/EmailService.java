...
public class EmailService {
    ...
    public void sendVerificationEmail(String email, String verificationToken) {
        String subject = "Email de Vérification";
        String path = "/api/req/signup/verify";
    ...
    public void sendForgotPasswordEmail(String email, String resetToken) {
        ...
        String path = "/api/req/reset-password";
        ...
        try {
            ...
            String content = """
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border-radius: 8px; background-color: #f9f9f9; text-align: center;">
                        ...
                        <a href="%s" style="display: inline-block; margin: 20px 0; padding: 10px 20px; font-size: 16px; color: #fff; background-color: #007bff; text-decoration: none; border-radius: 5px;">Continuer</a>
